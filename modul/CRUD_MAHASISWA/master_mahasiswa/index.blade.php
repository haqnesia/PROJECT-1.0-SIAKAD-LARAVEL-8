...
<script>
    ...
    $(document).on('submit', '#mahasiswa_save', function (e) {
        e.preventDefault();
    ...
    $(document).on('click', '[data-act=item_edit]', function (e) {
        ...
        $.get("{{ route('mahasiswa.edit') }}", { nim: nim })
            .done(function (r) {
                if (r.success) {
    ...
    $(document).on('submit', '#mahasiswa_update', function (e) {
        e.preventDefault();
    ...
    $(document).on('click', '[data-act=item_aktif]', function (e) {
        ...
        $.post("{{ route('mahasiswa.aktif') }}", { nim: nim })
            .done(function (r) {
                if (r.success) {
    ...
    $(document).on('click', '[data-act=item_nonaktif]', function (e) {
        ...
        $.post("{{ route('mahasiswa.nonaktif') }}", { nim: nim })
            .done(function (r) {
                if (r.success) {
