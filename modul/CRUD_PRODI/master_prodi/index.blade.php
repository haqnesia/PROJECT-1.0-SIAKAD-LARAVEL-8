...
<script>
    ...
    $(document).on('submit', '#prodi_save', function (e) {
        e.preventDefault();
    ...
    $(document).on('click', '[data-act=item_edit]', function (e) {
        ...
        $.get("{{ route('prodi.edit') }}", { kode: kode })
            .done(function (r) {
                if (r.success) {
    ...
    $(document).on('submit', '#prodi_update', function (e) {
        e.preventDefault();
    ...
    $(document).on('click', '[data-act=item_aktif]', function (e) {
        ...
        $.post("{{ route('prodi.aktif') }}", { kode: kode })
            .done(function (r) {
                if (r.success) {
    ...
    $(document).on('click', '[data-act=item_nonaktif]', function (e) {
        ...
        $.post("{{ route('prodi.nonaktif') }}", { kode: kode })
            .done(function (r) {
                if (r.success) {
